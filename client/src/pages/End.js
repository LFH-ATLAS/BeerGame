...
<h3 class="text-center mt-3">Produzent:</h3>
<div className={"grid_play2"}>
    ...
    <h3 class="text-center mt-3">Verteiler:</h3>
    <div className={"grid_play2"}>
                    <div className={"playground2"}>
                        <div className={"KPItable"}>
    <table>
    ...
    <h3 class="text-center mt-3">Großhändler:</h3>
    <div className={"grid_play2"}>
                    <div className={"playground2"}>
                        <div className={"KPItable"}>
    <table>
    ...
    <h3 class="text-center mt-3">Einzelhändler:</h3>
    <div className={"grid_play2"}>
                    <div className={"playground2"}>
                        <div className={"KPItable"}>
    <table>
